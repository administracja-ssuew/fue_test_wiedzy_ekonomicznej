  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--fue-bg)", display: "flex", justifyContent: "center", fontFamily: '"Outfit",sans-serif', color: "#EDE9FE" }}>
      <div className="fue-page" style={{ padding: isDesktop ? "40px 0 48px" : "40px 24px 32px", position: "relative" }}>
        ...
        <button onClick={onPractice} style={{ background: "rgba(255,255,255,.05)", border: "1px solid rgba(255,255,255,.1)", borderRadius: 12, padding: "12px", fontSize: 13, color: "#C4B5FD", cursor: "pointer", width: "100%", fontFamily: '"Outfit",sans-serif', fontWeight: 600 }}>
